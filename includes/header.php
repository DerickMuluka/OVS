<header style="display: flex; flex-direction: column; align-items: center; padding: 0; margin: 0;">
    <h1 style="margin: 0; font-size: 2em; width: 100%; padding: 20px 0; background-color: #4CAF50; color: #fff; text-align: center; position: relative; z-index: 1;">Online Voting System</h1>
    <nav class="navbar" style="width: 100%; padding: 10px 20px; background-color: #66b3ff; border-radius: 0; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); position: relative; top: 0; z-index: 0;">
